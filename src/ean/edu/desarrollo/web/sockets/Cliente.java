...
public class Cliente extends JFrame 
{
	...
	/******************************************************/
	/******************************************************/
	private static final long serialVersionUID = -6436925361026797466L;
	...
	{      
		...
		// mostrar la informaci�n de la conexion
	...
	private void enviarDatos( String mensaje )
	{
		...
		try {
                        ...
                        //salida.writeObject( items.getItemCadena());
                        salida.flush();
                        mostrarMensaje("\nEstos son sus productos>>> " + mensaje);
	...
	public static void main( String args[] )
	{
		...
		ipServidor = JOptionPane.showInputDialog(null,"Ingrese la IP del servidor: ");
		...
		*/
		...
		aplicacion = new Cliente(ipServidor);
